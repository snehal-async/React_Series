...
//   let[arr,setArr]=useState(["Snehal","Sandip","Shivam","Sayali","Sachin"]);
//   console.log(arr);
...
const App = () => {
  ...
  const [productArr, setProductArr] = useState([{"id":1,
  ...
  const deleteProduct=(id) =>{
    ...
    let res=productArr.filter((elem) => elem.id !== id);
    setProductArr(res);
  ...
  return (
    <div className="h-screen flex-col items-center p-4 gap-4">
      ...
      {productArr.length===0 ? (<h1 className='text-8xl font-semibold flex justify-center'>No Items...</h1>
      ) : (
        <div className='h-[100%] w-full flex flex-wrap gap-4'>
